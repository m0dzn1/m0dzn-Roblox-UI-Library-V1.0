...
-- flags table, every element registers itself here automatically
-- this is how the config system knows what to save and load
Library.Flags = {}
...
-- theme presets, dark is the default (obsidian + crimson)
local Themes = {
...
-- saves all current flag values to a json file
...
-- loads a config file and updates all ui elements to match
...
function Library:CreateWindow(Config)
    ...
    -- main window frame, starts at 0 size and tweens open
    ...
    -- outer border stroke, crimson by default
    ...
    -- red glow blob in the background, like the reference image
    local GlowBlob = Instance.new("ImageLabel")
    GlowBlob.Size = UDim2.new(0, 340, 0, 260)
    GlowBlob.Position = UDim2.new(0.5, -170, 0, -80)
    GlowBlob.BackgroundTransparency = 1
    GlowBlob.Image = "rbxassetid://5028857472"
    GlowBlob.ImageColor3 = Color3.fromRGB(180, 20, 30)
    GlowBlob.ImageTransparency = 0.72
    GlowBlob.ZIndex = 0
    GlowBlob.Parent = MainFrame

    -- thin red line at the very top of the window
    ...
    -- topbar is transparent, just used for dragging and title
    ...
    -- title text, bold and uppercase like the reference image
    ...
    -- player profile card at bottom left
    local ProfileFrame = Instance.new("Frame")
    ProfileFrame.Size = UDim2.new(0, 138, 0, 42)
    ProfileFrame.Position = UDim2.new(0, 0, 1, -42)
    ProfileFrame.BackgroundTransparency = 0.05
    ProfileFrame.Parent = Content
    Instance.new("UICorner", ProfileFrame).CornerRadius = UDim.new(0, 7)
    AddToRegistry(ProfileFrame, "BackgroundColor3", "Top")

    local ProfileAccent = Instance.new("Frame")
    ProfileAccent.Size = UDim2.new(0, 3, 1, 0)
    ProfileAccent.Position = UDim2.new(0, 0, 0, 0)
    ProfileAccent.BorderSizePixel = 0
    ProfileAccent.Parent = ProfileFrame
    Instance.new("UICorner", ProfileAccent).CornerRadius = UDim.new(0, 7)
    ...
    DispName.Position = UDim2.new(0, 45, 0, 6)
    ...
    UsrName.Position = UDim2.new(0, 45, 0, 21)
    ...
    -- thin vertical divider between tabs and content
    ...
    -- keybind to toggle the window visibility
    ...
    -- notification popup in the bottom right
    function Window:Notification(text)
        task.spawn(function()
            PlaySound(Sounds.Notification)
            local Notif = Instance.new("Frame")
            Notif.ZIndex = 100
            Notif.Size = UDim2.new(0, 265, 0, 46)
            Notif.Position = UDim2.new(1, 20, 1, -65)
            ...
            NAccentBar.Size = UDim2.new(0, 3, 1, 0)
            NAccentBar.BackgroundTransparency = 0
            NAccentBar.ZIndex = 101
            NAccentBar.Parent = Notif
            Instance.new("UICorner", NAccentBar).CornerRadius = UDim.new(0, 7)
            ...
            Tween(Notif, {Position = UDim2.new(1, -285, 1, -65)}, 0.55)
            task.wait(3)
            Tween(Notif, {Position = UDim2.new(1, 20, 1, -65)}, 0.55)
            task.wait(0.6)
            Notif:Destroy()
        end)
    end
    ...
    function Window:Tab(name)
        ...
        TabBtn.TextColor3 = Color3.fromRGB(95, 95, 100)
        TabBtn.TextSize = 12
        TabBtn.Parent = TabContainer
        Instance.new("UICorner", TabBtn).CornerRadius = UDim.new(0, 6)

        -- small red indicator bar on the left side of the active tab
        ...
        TabBtn.MouseButton1Click:Connect(function()
            ...
            for _, v in pairs(TabContainer:GetChildren()) do
                if v:IsA("TextButton") then
                    Tween(v, {BackgroundTransparency = 1, TextColor3 = Color3.fromRGB(95, 95, 100)})
                    local bar = v:FindFirstChildOfClass("Frame")
                    if bar then Tween(bar, {BackgroundTransparency = 1}) end
                end
            end
            Page.Visible = true
            Tween(TabBtn, {BackgroundTransparency = 0.07, TextColor3 = CurrentTheme.Text, BackgroundColor3 = CurrentTheme.Top})
        ...
        if firstTab then
            ...
            TabBtn.BackgroundTransparency = 0.07
        ...
        -- section header, styled like a subtle label above a group of elements
        ...
        -- helper to make a consistent dark tile for each element
        ...
        function Elements:Value(text, default, callback)
            ...
            ValBox.Size = UDim2.new(0.28, 0, 0, 26)
            ValBox.Position = UDim2.new(0.72, -14, 0.5, -13)
        ...
        function Elements:Keybind(text, default, callback)
            ...
            KeyLabel.Size = UDim2.new(0, 82, 0, 26)
            KeyLabel.Position = UDim2.new(1, -96, 0.5, -13)
        ...
        function Elements:Button(text, callback)
            ...
            -- hover tint
            Btn.MouseEnter:Connect(function() Tween(Btn, {BackgroundTransparency = 0.0}, 0.2) end)
            Btn.MouseLeave:Connect(function() Tween(Btn, {BackgroundTransparency = 0.04}, 0.2) end)
        end
        ...
        function Elements:Toggle(text, default, callback)
            ...
            Switch.BackgroundColor3 = Enabled and CurrentTheme.Accent or Color3.fromRGB(28, 28, 33)
            ...
            local function Update()
                ...
                Tween(Switch, {BackgroundColor3 = Enabled and CurrentTheme.Accent or Color3.fromRGB(28, 28, 33)})
        ...
        function Elements:Slider(text, min, max, default, callback)
            ...
            Num.Position = UDim2.new(1, -54, 0, 10)
            ...
            Bar.BackgroundColor3 = Color3.fromRGB(28, 28, 33)
            ...
            local function Update(newVal)
                ...
                Tween(Fill, {Size = UDim2.new(p, 0, 1, 0)}, 0.18)
                Num.Text = tostring(Val)
                Library.Flags[text] = Val
        ...
        function Elements:Dropdown(text, options, callback)
            ...
            local function RefreshOptions(newOpts)
                ...
                for _, opt in pairs(newOpts) do
                    ...
                    O.TextColor3 = Color3.fromRGB(155, 155, 160)
                    O.Font = Enum.Font.GothamMedium
                    O.TextSize = 12
                    O.BackgroundTransparency = 1
                    O.Parent = Container
                    O.MouseButton1Click:Connect(function() Select(opt) end)
                    O.MouseEnter:Connect(function() Tween(O, {TextColor3 = CurrentTheme.Accent}, 0.18) end)
                    O.MouseLeave:Connect(function() Tween(O, {TextColor3 = Color3.fromRGB(155, 155, 160)}, 0.18) end)
                end
            end
            ...
            Btn.MouseButton1Click:Connect(function()
                ...
                if Dropped then
                    ...
                    Tween(Container, {Size = UDim2.new(1, 0, 0, #Container:GetChildren() * 34)}, 0.35)
                    Tween(Icon, {Rotation = 180}, 0.35)
                else
                    Tween(Container, {Size = UDim2.new(1, 0, 0, 0)}, 0.28)
                    Tween(Icon, {Rotation = 0}, 0.28)
                    task.wait(0.3)
    ...
    -- config tab with orion-style save and load
    ...
    -- settings tab, auto added at the bottom
